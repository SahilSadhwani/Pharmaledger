           ...
           ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Pending Orders from Retailers
...
//                    echo $student_name;
                    ...
                    echo"<tr>";
                              ...
                              echo "<td>{$product_quantity}</td>";
                                        ...
                                        // echo"<td>{}</td>";
                                        echo"<td> <a href='qrcode3.php?orderId={$row['retailer_order_id']}&quantity={$product_quantity}' class = 'btn btn-success'>Approve</a> </td>";
                                        echo"<td> <a href= 'retailerdeclineorder.php?wholesaler_order_id=$retailer_order_id' class = 'btn btn-danger '>Decline</a></td>";
