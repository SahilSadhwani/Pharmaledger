...
-->
                    ...
                    <a id="linkbtn" href="scripts/receive.php?orderId=<?php echo $orderId ?>" class="btn btn-success" style="margin-left:120px;">Aprrove and Receive</a>
                    <a href="scripts/reject.php.?orderId=<?php echo $orderId ?>" class="btn btn-danger" style="margin-left:120px;">Reject order</a>
...
<![endif]-->
       ...
       var count=0;
        ...
        scanner.addListener('scan', function(content) {
            ...
            }else if(hasharr.indexOf(content)!=-1 && content_array.includes(content)==true){
				count++;
				alert("duplicate!!");
				dupcount++;
			}else{
			...
			if(count==total)
                {
                    alert("All products have been scanned!!");
					...
					console.log("asli count "+content_array.length+" nakli count "+(total-content_array.length-dupcount+" dup count "+dupcount));
                }
