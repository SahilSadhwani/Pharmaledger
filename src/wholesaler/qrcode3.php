                        ...
                        <div class="row">
                            <div class="col-md-8" style = "margin-left : 8%" >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div id="linkbtn">
                                        <button class = "btn btn-success" onclick="sendhashes()" href="">Approve</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<![endif]-->
        ...
        var total;
            ...
            function sendhashes()
            {
                ...
                $.ajax({ 
               type: "POST", 
               url: "../Retailer/hashinserter.php", 
               data: { hasharray : content_array,
                        orderId : orderid,
                        quantity : quantity
                     }, 
        ...
        $(document).ready(function (){
            ...
            orderid=finalsplit[0];
            quantity=finalsplit[1];
            quantity=quantity.split("=");
            quantity=quantity[1];
            orderid=orderid.split("=");
            var div=document.getElementById("linkbtn");
            div.style.display="none";
            orderid=orderid[1];
            alert(orderid+" "+quantity);
...
//            }
            ...
            count++;
            alert("scanned "+content+" count "+count);
            
            if(count==quantity)
                {
                    alert("all qrs scannedd!!");
                    var div=document.getElementById("linkbtn");
