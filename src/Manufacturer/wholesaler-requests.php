        ...
        <div class="page-container">
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            <a href="add-product.html" class="nav-link nav-toggle">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">View My Products</span>
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">Orders for Me</span>
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="fa fa-cubes"></i>
                                <span class="title">Rejected Orders by Wholesalers</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                ...
                                <li class="nav-item  ">
                                 ...
                                 <li class="nav-item  ">
                                    <a href="#" class="nav-link ">
                                        <span class="title">Faulty/Manipulated</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title">Wholesaler requests
                        <small></small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                                    ...
                                    <div class="portlet light portlet-fit portlet-form bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-dark sbold uppercase">Wholesaler requests</span>
                                            </div>
                                        </div>
...
require_once("../db.php");
$query = "SELECT * FROM wholesaler_manufacturer WHERE connection_status = 0";
        ...
        <tbody>
           <?php
            while($row = mysqli_fetch_assoc($result)){
                echo "<tr><td>{$row['wholesaler_id']}</td>
                <td><a href='scripts/wholesaler_status.php?wholesaler_id={$row['wholesaler_id']}&status=accept' class='btn green'>Accept</a></td>
                <td><a href='scripts/wholesaler_status.php?wholesaler_id={$row['wholesaler_id']}&status=reject' class='btn red'>Reject</a></td>
                </tr>";
            }
