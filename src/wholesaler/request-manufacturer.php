        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title">Request Manufacturer
                        <small>Request manufacturer</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                                    ...
                                    <div class="portlet light portlet-fit portlet-form bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-dark sbold uppercase">Request Manufacturer</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            ...
                                            <!-- BEGIN FORM-->
<form action="request-manufacturer.php" class="form-horizontal" method="get" enctype="multipart/form-data">
    ...
    <div class="form-body">
       ...
       <?php
        ...
        require_once("../db.php");
        $query = "SELECT company_city FROM manufacturer";
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select name="company_city" id="" class="form-control" required>
                            <option value="">Select Location</option>
                            <?php
                            while($row = mysqli_fetch_assoc($result)){
                                echo "<option value='{$row['company_city']}'>{$row['company_city']}</option>";
                            }
                            ?>
    ...
    <div class="form-actions">
        <div class="row">
            <div class="col-md-offset-3 col-md-9">
                <button type="submit" class="btn green" name="" href="">Filter</button>
            </div>
        </div>
    </div>
</form>
<!-- END FORM-->
        ...
        if(isset($_GET["company_city"])){
            $city = $_GET["company_city"];
            
        }
                                            
    
            $query = "SELECT * FROM manufacturer WHERE company_city = '$city'";
            $result = mysqli_query($connection, $query);
            
            while($row = mysqli_fetch_assoc($result)){
                echo "<tr><td>{$row['company_name']}</td><td>{$row['company_address']}</td><td>{$row['company_contact_number']}</td><td>{$row['company_email_id']}</td><td><a class='btn green' href='scripts/request.php?manufacturer_id={$row['uid']}'>Request</a></td></tr>";
            }
